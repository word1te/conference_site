    ...
    <section className={style.section}>
      ...
      <div className={style.information}>
        ...
        <p className={style.information_text}>
          Эра JavaScript'а начинается в 2015 году вместе с выходом ECMAScript 6,
          после которого он стал полноценным, более не костыльным языком. После
          релиза ECMAScript 6 frontend стал активно развиваться, появилось много
          новых и удобных инструментов для разработки, финансируемых крупными
